...
public class MainActivity extends TabActivity {
	...
	private ArrayList<Abas> Factory() {
		...
		String[] vestuario = { "Camisas", "Calças", "Shortes",
				"Roupas Íntimas", "Casaco", "Sapato", "Sandália" };
		String[] higiene = { "Creme Dental", "Escova de Dentes",
				"Shampoo & Condicionador", "Hidratante", "Perfume", "Toalha" };
		String[] acessorio = { "Câmera", "Celular", "Notebook", "Vitamina C",
		"Primeiros socorros" };
			String[] documentos = { "Identidade","CPF","Passaporte", "Passagem" };
			lista.add(new Abas("Vestuario", vestuario));
			lista.add(new Abas("Higiene", higiene));
			lista.add(new Abas("Acessório", acessorio));
			lista.add(new Abas("Documentos", documentos));
		return lista;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.item1) {
			...
			alert = alertB.create();
			alertB.setTitle("Adicionar Itens");
			alertB.setMessage("Nome do novo item:");
